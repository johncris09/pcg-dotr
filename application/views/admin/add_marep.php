							...
							<div class="panel panel-primary setup-content" id="step-2">
								...
								<div class="panel-body">  
									...
									?>
											...
											<div data-id="<?php echo $row['report_selection_id']; ?>"  class="toggle-show" style="display: none">	
											...
											<form method="post" action="<?= site_url() ?>insert_marep" role="form" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-sm-12">
															<input type="text" name="garbage_collected_volume" class="form-control"  > 
											...
											<form method="post" action="<?= site_url() ?>insert_marep" role="form" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
														<label class="col-sm-12">NUMBER OF PARTICIPANTS</label> 
															<input type="text" name="participant_number"  class="form-control"  > 
														</div> 
													</div> 
													<div class="col-md-6">
														<div class="form-group">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-sm-12">
															<input type="text" name="seedlings_planted_number" class="form-control"  >  
														</div>
													</div>
												</div>   
												<button type="submit" class="btn btn-danger pull-right" type="button">Finish!</button>  
									...
									<?php 
										}else if(  $row['report_selection_id'] == 5){ // LAND BASE INSPECTION
									?>
											<form method="post" action="<?= site_url() ?>insert_marep" role="form" enctype="multipart/form-data"> 
												<!-- hidden -->
												<input type="hidden" title="Station" name="station">
									...
									<?php 
										}else if(  $row['report_selection_id'] == 6){ // TRAININGS CONDUCTED
									?>
											<form method="post" action="<?= site_url() ?>insert_marep" role="form" enctype="multipart/form-data"> 
												<!-- hidden -->
												<input type="hidden" title="Station" name="station">
									...
									<?php 
										}else if(  $row['report_selection_id'] == 7){ // MARITIME INCIDENT
									?>		

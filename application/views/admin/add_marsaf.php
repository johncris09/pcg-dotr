                        ...
                        <div class="panel-body">
                            ...
                            <div class="toggle-show" data-id="<?php echo $report_type_id; ?>" style="display:none">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="vessel_type"
                                                        id="vessel_type_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="vessel_type_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->vessel_type ?></label>
                                                </div>
                                                <?php
																		}
																	?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="pdi_result"
                                                        id="pdi_result_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="pdi_result_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->pdi_result ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="action_code"
                                                        id="action_code_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="action_code_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->action_code ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="noted_deficiency"
                                                        id="noted_deficiency_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="noted_deficiency_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->noted_deficiency ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="noted_deficiency2s"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox-list">
                                                    ...
                                                    <label class="checkbox-inline p-0">
                                                        <div class="checkbox checkbox-info">
                                                            <input type="checkbox" name="depart"
                                                                id="<?php echo $row->pdi_result . "_" .  $report_type_id . "_" . $row->id   ?>"
                                                                value="<?php echo $i; ?>">
                                                            <label
                                                                for="<?php echo $row->pdi_result . "_" .  $report_type_id . "_" . $row->id   ?>"><?php echo $i; ?></label>
                                                        </div>
                                                    </label>
                                                    <?php
                                                    ...
                                                    <label class="checkbox-inline p-0">
                                                        <div class="checkbox checkbox-info">
                                                            <input type="checkbox" name="depart" id="depart1"
                                                                value="<?php echo $i; ?>">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="checkbox checkbox-custom">
                                                        <input type="checkbox" name="inspection_type"
                                                            id="inspection_type_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                            value="<?php echo $row->id  ?>">
                                                        <label
                                                            for="inspection_type_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->inspection_type ?></label>
                                                    </div>
                                                    <?php
																				}
																			?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="vsei_result"
                                                        id="vsei_result_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="vsei_result_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->vsei_result ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="vsei_deficiency_code"
                                                        id="vsei_deficiency_code_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="vsei_deficiency_code_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->vsei_deficiency_code ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox-list">
                                                    ...
                                                    <label class="checkbox-inline p-0">
                                                        <div class="checkbox checkbox-info">
                                                            <input type="checkbox" name="<?php echo $stat; ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <?php 
																			...
																			?>
                                                    <div class="checkbox checkbox-custom">
                                                        <input type="checkbox" name="drill_conducted"
                                                            id="drill_conducted_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                            value="<?php echo $row->id  ?>">
                                                        <label
                                                            for="drill_conducted_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->drill_conducted ?></label>
                                                    </div>
                                                    <?php
																				}
																			?>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-12">ACTION CODES (IF VESSEL HAS NOTED
                                                DEFICIENCY)</label>
                                            <div class="col-sm-12">
                                                <?php 
                                                ...
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="psc_action_code"
                                                        id="psc_action_code_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="psc_action_code_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->psc_action_code ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="col-sm-12">RELATED INTERNATIONAL CONVENTIONS NOTED
                                                DEFICIENCY/IES</label>
                                            <div class="col-sm-12">
                                                <?php 
                                                ...
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox"
                                                        name="related_international_conventions_noted_deficiency"
                                                        id="related_international_conventions_noted_deficiency_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="related_international_conventions_noted_deficiency_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->related_international_conventions_noted_deficiency ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="beach_coast_line_length"
                                                        id="beach_coast_line_length_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="beach_coast_line_length_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->beach_coast_line_length ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="coastal_and_beach_violation"
                                                        id="coastal_and_beach_violation_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="coastal_and_beach_violation_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->coastal_and_beach_violation ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="recration_watercraft"
                                                        id="recration_watercraft_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="recration_watercraft_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->recration_watercraft ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="recreational_violation"
                                                        id="recreational_violation_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="recreational_violation_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->recreational_violation ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <?php 
																			...
																			?>
                                                    <div class="checkbox checkbox-custom">
                                                        <input type="checkbox" name="lighthouse_type"
                                                            id="lighthouse_type_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                            value="<?php echo $row->id  ?>">
                                                        <label
                                                            for="lighthouse_type_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->lighthouse_type ?></label>
                                                    </div>
                                                    <?php
																				}
																			?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="lighthouse_inspection_purpose"
                                                        id="lighthouse_inspection_purpose_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="lighthouse_inspection_purpose_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->lighthouse_inspection_purpose ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="lighthouse_status"
                                                        id="lighthouse_status_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="lighthouse_status_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->lighthouse_status ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="lighthouse_cause_if_not_operating"
                                                        id="lighthouse_cause_if_not_operating_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="lighthouse_cause_if_not_operating_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->lighthouse_cause_if_not_operating ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="radio-list">
                                                    ...
                                                    <label class="radio-inline p-0">
                                                        <div class="radio radio-info">
                                                            <input type="radio"
                                                                name="<?php echo $row->lighthouse_status; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="bouy_type"
                                                        id="bouy_type_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="bouy_type_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->bouy_type ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="light_bouy_inspection_purpose"
                                                        id="light_bouy_inspection_purpose_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="light_bouy_inspection_purpose_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->light_bouy_inspection_purpose ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="light_buoy_status"
                                                        id="light_buoy_status_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="light_buoy_status_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->light_buoy_status ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="light_buoy__cause_if_not_operating"
                                                        id="light_buoy__cause_if_not_operating_<?php echo $report_type_id . "_" . $row->id  ?>"
                                                        value="<?php echo $row->id  ?>">
                                                    <label
                                                        for="light_buoy__cause_if_not_operating_<?php echo $report_type_id . "_" . $row->id  ?>"><?php echo $row->light_buoy__cause_if_not_operating ?></label>
                                                </div>
                                                <?php
																			}
																		?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="radio-list">
                                                    ...
                                                    <label class="radio-inline p-0">
                                                        <div class="radio radio-info">
                                                            <input type="radio"
                                                                name="<?php echo $row->light_buoy_status; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="maritime_casualty_nature"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="incident_consequences"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <?php 
																		...
																		?>
                                                <div class="checkbox checkbox-custom">
                                                    <input type="checkbox" name="very_serious_mc_category"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <?php 
																	...
																	?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="application_type"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <?php 
																	...
																	?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="salvage_operation_purpose"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <?php 
																	...
																	?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="maritime_acitivity"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <?php 
																	...
																	?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="maritime_related_violation"

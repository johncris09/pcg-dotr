                ...
                <form method="POST" action="<?= site_url() ?>insert_marep" role="form" enctype="multipart/form-data">
                    <div class="panel panel-primary setup-content" id="step-1">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <p><strong style="font-size: 1.3em;color: #000;">ENTER DATA FOR MARITIME SEARCH AND
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="maritime-incident" class="form-control" required>
                                            ...
                                            <option value="<?php echo $row->id; ?>">
                                                <?php echo $row->maritime_incident_type ?></option>
                                            <?php
															}
														?>
                                        </select>
                    ...
                    <div class="panel panel-primary setup-content" id="step-2">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="toggle-show" data-id="<?php echo $maritime_incident_type_id; ?>"
                                style="display:none">
                                <?php 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p><strong
                                                style="font-size: 1.3em;color: #000;"><?php echo $row->maritime_incident_type; ?></strong>
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="incident_cause"
                                                    id="incident_cause_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?php echo $row->id  ?>">
                                                <label
                                                    for="incident_cause_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"><?php echo $row->incident_cause ?></label>
                                            </div>
                                            <?php
																		}
																	?>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="fire_cause"
                                                    id="fire_cause_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?php echo $row->id  ?>">
                                                <label
                                                    for="fire_cause_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"><?php echo $row->fire_cause ?></label>
                                            </div>
                                            <?php
																		}
																	?>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="man_overboard_incident_cause"
                                                    id="man_overboard_incident_cause_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?php echo $row->id  ?>">
                                                <label
                                                    for="man_overboard_incident_cause_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"><?php echo $row->man_overboard_incident_cause ?></label>
                                            </div>
                                            <?php
																		}
																	?>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="vessel_type_involved"
                                                    id="vessel_type_involved_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?php echo $row->id  ?>">
                                                <label
                                                    for="vessel_type_involved_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"><?php echo $row->vessel_type_involved ?></label>
                                            </div>
                                            <?php
																		}
																	?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="maritime-incident" class="form-control" required="">
                                                ...
                                                <?php 
																		...
																		?>
                                                <option value="<?php echo $row->id; ?>"><?php echo $row->vessel_age ?>
                                                </option>
                                                <?php
																			}
																		?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="maritime-incident" class="form-control" required="">
                                                <option value="">Select</option><?php 
																		...
																		?>
                                                <option value="<?php echo $row->id; ?>"><?php echo $row->vessel_size ?>
                                                </option>
                                                <?php
																			}
																		?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <?php 
																	...
																	?>
                                            <div class="checkbox checkbox-custom">
                                                <input type="checkbox" name="vessel_size"
                                                    id="vessel_size_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"
                                                    value="<?php echo $row->id  ?>">
                                                <label
                                                    for="vessel_size_<?php echo $maritime_incident_type_id . "_" . $row->id  ?>"><?php echo $row->vessel_size ?></label>
                                            </div>
                                            <?php
																		}
																	?>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="checkbox checkbox-custom">
                                            <input id="agency1" type="checkbox">
                                            <label for="agency1">PARTIALLY DAMAGE BUT CAN BE PROPELLED ON HER
                                                OWN</label>
                                        </div>
                                        <div class="checkbox checkbox-custom">
                                            <input id="agency1" type="checkbox">
                    ...
                    <div class="panel panel-primary setup-content" id="step-7">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="col-sm-12">Provide Brief Description on the extent of damage of
                                            Vessel.</label>
